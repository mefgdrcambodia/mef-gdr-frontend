...
const CircularPage = () => {
  ...
  const getCategoryDisplayName = () =>
    currentLang === "km" ? "សារាចរ" : "Circular";
  ...
  const translations = {
    ...
    en: {
      title: "Circulars",
      subtitle: "Circulars and guidelines",
      search: "Search by title or content...",
      downloadKh: "Download in Khmer",
      downloadEn: "Download in English",
      view: "View",
      documentNumber: "Circular Number",
      noDocuments: "No circulars found",
      viewPdf: "View PDF",
      showing: "Showing",
      to: "to",
      ofTotal: "of",
      ...
      totalDocuments: "Total Circulars",
      loading: "Loading...",
      shareVia: "Share via",
      copyLink: "Copy Link",
      copied: "Copied!",
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              {searchTerm && (
                <button
                  ...
                  className="px-4 py-2.5 text-sm text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg flex items-center gap-2"
                >
                  <X size={14} />
                  {t.clearFilters}
                </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-xl border border-gray-100">
            <div className="w-24 h-24 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <ScrollText size={40} className="text-gray-400" />
            </div>
            ...
            {searchTerm && (
              <button
                onClick={clearFilters}
                className="mt-4 px-4 py-2 text-sm text-[#4CAF50] hover:bg-green-50 rounded-lg"
              >
                {t.clearFilters}
              </button>
            )}
                ...
                >
                  <div className="flex flex-col sm:flex-row p-4 gap-4">
                    <div className="relative w-full sm:w-36 h-32 sm:h-full min-h-[128px] bg-gray-100 rounded-lg overflow-hidden flex-shrink-0">
                      ...
                      />
                      <div className="absolute top-2 right-2 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white px-1.5 py-0.5 rounded-md text-[10px] font-medium">
                        PDF
                      </div>
        ...
        {!loading && totalPages > 1 && (
          <div className="mt-8 flex items-center justify-center gap-1">
            <button
              ...
              disabled={page === 1}
              className="w-10 h-10 flex items-center justify-center rounded-lg border border-gray-200 hover:bg-gray-50 disabled:opacity-40"
            >
              <ChevronLeft size={18} />
            </button>
            {[...Array(Math.min(5, totalPages))].map((_, i) => {
              ...
              return (
                <button
                  ...
                  className={`w-10 h-10 flex items-center justify-center rounded-lg text-sm font-medium ${page === pageNum ? "bg-[#4CAF50] text-white" : "border border-gray-200 hover:bg-gray-50"}`}
                >
                  {pageNum}
                </button>
              );
            ...
            <div className="max-w-4xl mx-auto">
              <div className="sticky top-0 bg-white border-b border-gray-100 z-10 py-4 mb-6">
                <div className="flex items-center justify-between">
                  <button
                    ...
                    className="flex items-center space-x-2 text-gray-500 hover:text-[#2E7D32] group"
                  >
                    <ChevronRightIcon
                      size={16}
              ...
              <div className="flex flex-col md:flex-row gap-6">
                <div className="relative w-56 h-auto min-h-[288px] bg-gray-100 rounded-xl overflow-hidden shadow-lg flex-shrink-0 mx-auto md:mx-0">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-cyan-500 text-white px-2 py-1 rounded-lg text-xs font-medium">
                    PDF
                  </div>
                </div>
                <div className="flex-1">
        ...
        <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6">
            ...
            <div className="flex items-center gap-2">
              <input
                type="text"
                value={`${window.location.origin}/legal/circular/${selectedDocument.id}`}
                readOnly
