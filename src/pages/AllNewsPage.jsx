...
const AllNewsPage = () => {
  ...
  const relatedNews = localNews
    .filter(
      (i) => i.id !== selectedNews?.id && i.category === selectedNews?.category,
    )
    .slice(0, 3);
  ...
  const getCategoryDisplayName = (key) => {
    ...
    return currentLang === "km"
      ? found[key].kh || found[key].en || key
      : found[key].en || found[key].kh || key;
  };
  ...
  const translations = {
    km: {
      ...
      subtitle: "ព័ត៌មានថ្មីៗ និងសេចក្តីប្រកាសព័ត៌មាន",
      ...
      <button
        ...
        className={`flex items-center gap-1 text-xs px-2 py-1 rounded-lg border transition-all duration-200 ${
          item.liked
            ...
            : "border-transparent text-gray-400 hover:bg-red-50 hover:border-red-200 hover:text-red-400"
        }`}
      >
          ...
          >
            <div className="relative h-48 overflow-hidden bg-gray-100">
              ...
              <div className="absolute top-3 left-3">
                <span
                  className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium border ${getCategoryColor(item.category)}`}
                >
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6">
              ...
              <div className="relative lg:w-64 category-dropdown-container">
                ...
                >
                  <span className="flex items-center gap-2">
                    ...
                    <span
                      className={activeTab ? "text-gray-900" : "text-gray-500"}
                    >
                      {activeTab
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50 max-h-64 overflow-y-auto">
                    ...
                    >
                      <Filter
                        size={14}
                        className={
                          !activeTab ? "text-[#4CAF50]" : "text-gray-400"
                        }
                      />
                      {t.allCategories}
                    </button>
                    {!loading && categories.length > 0 ? (
                      categories.map((cat, i) => {
                        ...
                        return (
                          ...
                          >
                            <span
                              className={`w-5 h-5 rounded-full flex items-center justify-center ${getCategoryColor(key).split(" ")[0]}`}
                            >
                              {getCategoryIcon(key)}
                            </span>
                            {label}
          ...
          {(activeTab || searchQuery) && (
            <div className="px-5 pb-4 flex flex-wrap items-center gap-2 border-t border-gray-100 pt-4">
              ...
              {activeTab && (
                <span
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border ${getCategoryColor(activeTab)}`}
                >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
            <div className="relative h-[300px] md:h-[400px] rounded-xl overflow-hidden mb-8 bg-gray-100">
              ...
              <div className="absolute top-4 left-4">
                <span
                  className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium border bg-white/90 backdrop-blur-sm ${getCategoryColor(selectedNews.category)}`}
                >
          ...
          <div className="bg-white rounded-xl p-5 max-w-sm w-full mx-4 shadow-2xl">
            ...
            <div className="grid grid-cols-4 gap-3">
              {[
                ...
                >
                  <div
                    className={`w-10 h-10 ${s.bg} text-white rounded-full flex items-center justify-center transition-colors`}
                  >
                    {s.icon}
                  </div>
              ...
              <button
                ...
                className="flex flex-col items-center gap-1.5 p-2 hover:bg-gray-50 rounded-lg"
              >
                <div className="w-10 h-10 bg-gray-200 hover:bg-gray-300 text-gray-600 rounded-full flex items-center justify-center transition-colors">
                  <Link2 size={16} />
                </div>
